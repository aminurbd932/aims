              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        {{ HTML::image('admin/dist/img/user3-128x128.jpg', 'User Image', array('class' => 'img-circle')) }}
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        {{ HTML::image('admin/dist/img/user4-128x128.jpg', 'User Image', array('class' => 'img-circle')) }}
                      </div>
                      <h4>
                        Developers
