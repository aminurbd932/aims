...
@section('admin-content')
  ...
  <div class="row">
    ...
    {{ Form::open(array('url' => '/admin/save-admission-offer','class' => 'nform-horizontal index_form', 'autocomplete' => 'off')) }}
      ...
      <div class="col-xs-6 col-sm-6 col-md-2 col-lg-2">
        <div class="form-group {{ $errors->has('seat_number') ? ' has-error' : '' }}">
          ...
          {!! Form::text('seat_number', null, ['class' => 'form-control input-sm', 'required' => 'required']) !!}
