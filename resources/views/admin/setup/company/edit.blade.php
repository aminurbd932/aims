...
@section('admin-content')
  ...
  <div class="row">
    ...
    {{ Form::open(array('url' => '/admin/update-company/'.$record->id,'class' => 'nform-horizontal index_form', 'autocomplete' => 'off')) }}
      ...
      <div class="col-xs-6 col-sm-6 col-md-2 col-lg-2">
        <div class="form-group {{ $errors->has('type') ? ' has-error' : '' }}">
          ...
          @if ($company_type)
              {!!Form::select('type', $company_type, $record->type, ['class' => 'form-control', 'required' => 'required'])!!}
          @endif
