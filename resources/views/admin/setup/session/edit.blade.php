...
@section('admin-content')
  ...
  <div class="row">
    ...
    {{ Form::open(array('url' => '/admin/update-session/'.$record->id,'class' => 'nform-horizontal index_form', 'autocomplete' => 'off')) }}
      <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4 col-lg-offset-4">
        <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
          {!! Form::label('name', __('Session Name').'*', ['class' => 'control-label required']) !!} 
