...
@section('admin-content')
  ...
  <div class="row">
    ...
    {{ Form::open(array('url' => '/admin/update-customer/'.$record->id,'class' => 'nform-horizontal index_form', 'autocomplete' => 'off')) }}
      ...
      <div class="col-xs-6 col-sm-6 col-md-2 col-lg-2">
        <div class="form-group {{ $errors->has('type') ? ' has-error' : '' }}">
          ...
          @if ($customer_type)
              {!!Form::select('type', $customer_type, $record->type, ['class' => 'form-control', 'required' => 'required'])!!}
          @endif
      ...
      <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
        <div class="form-group {{ $errors->has('company_id') ? ' has-error' : '' }}">
          ...
          @if ($company_name)
              {!!Form::select('company_id', $company_name->pluck('name','id'), $record->company_id, ['class' => 'form-control', 'required' => 'required'])!!}
          @endif
