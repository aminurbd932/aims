...
@section('admin-content')
  ...
  <div class="row">
    ...
    {{ Form::open(array('url' => '/admin/update-medium/'.$record->id,'class' => 'nform-horizontal index_form', 'autocomplete' => 'off')) }}
      <div class="col-xs-6 col-sm-6 col-md-4 col-md-3 col-lg-3 col-lg-offset-3">
        <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
          {!! Form::label('name', __('Medium Name').'*', ['class' => 'control-label required']) !!} 
