...
@section('admin-content')
  ...
  <div class="row">
    ...
    {{ Form::open(array('url' => '/admin/update-program-offer/'.$record->id,'class' => 'nform-horizontal index_form', 'autocomplete' => 'off')) }}
      <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
        <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
          {!! Form::label('name', __('Program Offer Name').'*', ['class' => 'control-label required']) !!} 
      ...
      <div class="col-xs-6 col-sm-6 col-md-2 col-lg-2">
        <div class="form-group {{ $errors->has('section_id') ? ' has-error' : '' }}">
          ...
          @if ($section_list)
              {!!Form::select('section_id', $section_list->pluck('name','id'), $record->section_id, ['class' => 'form-control', 'required' => 'required'])!!}
          @endif
