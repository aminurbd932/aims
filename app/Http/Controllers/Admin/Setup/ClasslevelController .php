...
class ClasslevelController extends Controller
{
    ...
    public function store(classlevelFormRequest $request)
    {
        ...
        if ($sucess == 1) :
           return redirect('/admin/classlevel')->with('sweet-success', 'Successfully saved!');
        elseif ($sucess == 2) :
            return redirect('/admin/classlevel')->with('sweet-unsuccess', 'UnSuccessfully saved!');
        else :
            return redirect('/admin/classlevel')->with('sweet-error', 'Error!');;
        endif;
       // exit;
    }
    ...
    public function update(classlevelFormRequest $request, $id)
    {
        ...
        try{
           ...
           return redirect('/admin/add-classlevel')->with('sweet-error', 'Error!');
        }
    }
