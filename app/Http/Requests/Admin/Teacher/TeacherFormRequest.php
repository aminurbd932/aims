...
class TeacherFormRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        if ($id) {
            ...
            return [
                ...
                'teacher_code' => 'unique:applicants',
    ...
    public function messages()
    {
        return [
            ...
            'first_name.max' => 'The :attribute musts be at least 50 characters.',
