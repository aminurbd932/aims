...
(1, 1, 2, 'Dhaka', 1, '33', NULL, NULL, NULL, '2018-04-30 10:23:44', '2018-04-30 10:23:44'),
(2, 1, 1, 'Dhaka', 1, '12', NULL, NULL, NULL, '2018-05-08 10:22:07', '2018-05-08 10:22:07'),
(3, 2, 1, 'edeee', 1, '33', NULL, NULL, NULL, '2018-05-08 10:23:29', '2018-05-08 10:23:29');
...
(1, 1, '2018-10-05', '21:45:00', '23:45:00', '2018-05-08 09:46:02', '2018-05-08 09:47:14', 1, 1, 1, NULL),
(2, 2, '2018-05-10', '21:50:00', '00:50:00', '2018-05-08 10:02:38', '2018-05-08 10:04:22', 1, 1, 1, NULL);
...
(1, 'Class Six', 1, 2, 1, 1, 1, 2, 20, 1, '2018-05-07 12:20:33', '2018-05-08 08:55:57', 1, 0, 1, NULL),
(2, 'Class Seven', 1, 2, 2, 1, 1, 1, 22, 1, '2018-05-08 08:56:28', '2018-05-08 09:45:14', 1, 1, 1, NULL),
(4, 'Class Eight', 1, 2, 3, 1, 1, 2, 33, 0, '2018-05-08 09:16:03', '2018-05-08 09:16:11', 1, 1, 1, NULL);
...
(1, 'Bangla', '2018-05-07 12:16:43', '2018-05-07 12:16:43', 1, 0, 1, NULL),
(2, 'English', '2018-05-07 12:16:51', '2018-05-08 09:29:59', 1, 1, 1, NULL),
(3, 'Mathmatics', '2018-05-08 09:30:13', '2018-05-08 09:30:24', 1, 0, 1, NULL);
...
INSERT INTO `admission_subject_marks_mst` (`id`, `applicant_id`, `admission_offer_id`, `created_at`, `updated_at`, `created_by`, `updated_by`, `status`, `deleted_at`) VALUES
(1, 1, 1, '2018-05-08 10:29:45', '2018-05-08 10:29:45', 1, 0, 1, NULL),
(2, 2, 1, '2018-05-08 10:35:20', '2018-05-08 10:35:20', 1, 0, 1, NULL);
...
CREATE TABLE `applicants` (
  ...
  `is_student` tinyint(2) NOT NULL DEFAULT '0',
...
INSERT INTO `applicants` (`id`, `admission_offer_id`, `applicant_code`, `full_name`, `dob`, `blood_group_id`, `religion_id`, `national_id_no`, `birth_reg_no`, `phone`, `email`, `sex`, `assign_status`, `is_student`, `serial`, `created_at`, `updated_at`, `created_by`, `updated_by`, `deleted_at`) VALUES
(1, 1, '162207', 'Aminur Rahman', '2018-05-07', NULL, 1, NULL, '394838747', NULL, NULL, 1, 1, 1, 1, '2018-05-08 10:22:07', '2018-05-08 10:49:07', 1, 1, NULL),
(2, 1, '162329', 'Alam', '2018-05-08', NULL, 1, NULL, '3333', NULL, NULL, 2, 2, 1, 2, '2018-05-08 10:23:29', '2018-05-08 10:49:07', 1, 1, NULL);
...
--
-- Table structure for table `distribute_marks`
--

CREATE TABLE `distribute_marks` (
  `id` int(10) UNSIGNED NOT NULL,
  `subject_offer_id` int(10) UNSIGNED NOT NULL,
  `mark_type_id` int(10) UNSIGNED NOT NULL,
  `orginal_mark` decimal(10,2) NOT NULL,
  `percent_mark` decimal(10,2) NOT NULL,
  `divided_mark` decimal(10,2) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `created_by` int(11) NOT NULL,
  `updated_by` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `distribute_marks`
--

INSERT INTO `distribute_marks` (`id`, `subject_offer_id`, `mark_type_id`, `orginal_mark`, `percent_mark`, `divided_mark`, `created_at`, `updated_at`, `created_by`, `updated_by`, `deleted_at`) VALUES
(1, 2, 1, '50.00', '80.00', '40.00', '2018-05-02 11:50:10', '2018-05-05 02:07:05', 1, 1, NULL),
(3, 2, 4, '10.00', '100.00', '10.00', '2018-05-02 11:50:10', '2018-05-05 02:07:05', 1, 1, NULL),
(4, 1, 1, '70.00', '100.00', '70.00', '2018-05-05 00:18:06', '2018-05-05 02:06:44', 1, 1, NULL),
(5, 1, 2, '30.00', '100.00', '30.00', '2018-05-05 01:51:57', '2018-05-05 02:06:44', 1, 1, NULL);
...
INSERT INTO `exams` (`id`, `name`, `created_at`, `updated_at`, `created_by`, `updated_by`, `status`, `deleted_at`) VALUES
(1, 'First Term Exam', '2018-05-06 11:59:52', '2018-05-06 12:00:14', 1, 0, 1, NULL);
...
(1, 1, 2, 'Hamaid', NULL, NULL, 1, 'Nasrin', NULL, NULL, 7, NULL, NULL, NULL, 0, '2018-04-30 10:23:44', '2018-04-30 10:23:44'),
(2, 1, 1, 'Habib', NULL, '334455', 1, 'Nasiam', NULL, '33333', 13, 'Habib', '01921821909', '334444', 11, '2018-05-08 10:22:07', '2018-05-08 10:22:07'),
(3, 2, 1, 'ddd', NULL, '4333', 7, 'ddd', NULL, '333', 4, 'dddd', '01921821909', '33', 10, '2018-05-08 10:23:29', '2018-05-08 10:23:29');
...
--
-- Table structure for table `merge_subjects`
--

CREATE TABLE `merge_subjects` (
  `id` int(10) UNSIGNED NOT NULL,
  `name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `subject_offer_id` int(10) UNSIGNED NOT NULL,
  `status` tinyint(4) NOT NULL DEFAULT '1' COMMENT '1=active,2=inactive',
...
--
-- Dumping data for table `merge_subjects`
--

INSERT INTO `merge_subjects` (`id`, `name`, `subject_offer_id`, `status`, `created_at`, `updated_at`, `created_by`, `updated_by`, `deleted_at`) VALUES
(1, 'Bangla', 1, 1, '2018-05-06 11:28:11', '2018-05-06 11:28:11', 1, 0, NULL),
(2, 'Bangla', 2, 1, '2018-05-06 11:28:11', '2018-05-06 11:34:29', 1, 0, NULL);
...
(36, '2018_05_02_170642_create_distribute_marks_table', 2),
(37, '2018_05_05_094054_create_merge_subjects_table', 3),
(38, '2018_05_09_174353_create_students_table', 4),
(39, '2018_05_09_174836_create_student_promotions_table', 4),
(40, '2018_05_09_175049_create_student_subject_offers_table', 4),
(41, '2018_05_10_160717_create_departments_table', 4),
(42, '2018_05_10_160828_create_designations_table', 4);
...
(77, 'subject-offer-create', 'Add', NULL, '2018-04-30 09:50:04', '2018-04-30 09:50:04', 1, 0),
(78, 'subject-offer-view', 'View', NULL, '2018-04-30 09:50:22', '2018-04-30 09:50:22', 1, 0),
(79, 'subject-offer-edit', 'Edit', NULL, '2018-04-30 09:50:38', '2018-04-30 09:50:38', 1, 0),
(80, 'subject-offer-delete', 'Delete', NULL, '2018-04-30 09:51:10', '2018-04-30 09:51:10', 1, 0),
(81, 'subject-offer-status', 'Status', NULL, '2018-04-30 09:51:38', '2018-04-30 09:51:38', 1, 0),
(82, 'merge-subject-create', 'Add', NULL, '2018-05-05 11:10:15', '2018-05-05 11:10:15', 1, 0),
(83, 'merge-subject-edit', 'Edit', NULL, '2018-05-05 11:10:29', '2018-05-05 11:10:29', 1, 0),
(84, 'merge-subject-view', 'View', NULL, '2018-05-05 11:10:49', '2018-05-05 11:10:49', 1, 0),
(85, 'merge-subject-delete', 'Delete', NULL, '2018-05-05 11:11:06', '2018-05-05 11:11:06', 1, 0),
(86, 'merge-subject-status', 'Status', NULL, '2018-05-05 11:11:32', '2018-05-05 11:11:32', 1, 0),
(87, 'setup-config-view', 'View', NULL, '2018-05-06 11:41:23', '2018-05-06 11:41:23', 1, 0),
(88, 'setup-config-edit', 'Edit', NULL, '2018-05-06 11:41:34', '2018-05-06 11:41:34', 1, 0),
(89, 'student-promotion-create', 'Add', NULL, '2018-05-10 10:29:46', '2018-05-10 10:30:50', 1, 1),
(90, 'student-promotion-view', 'View', NULL, '2018-05-10 10:30:03', '2018-05-10 10:30:03', 1, 0),
(91, 'student-promotion-edit', 'Edit', NULL, '2018-05-10 10:30:23', '2018-05-10 10:30:23', 1, 0),
(92, 'student-promotion-delete', 'Delete', NULL, '2018-05-10 10:30:39', '2018-05-10 10:30:39', 1, 0),
(93, 'student-subject_offer-create', 'Add', NULL, '2018-05-10 10:31:30', '2018-05-10 10:31:30', 1, 0),
(94, 'student-subject_offer-view', 'View', NULL, '2018-05-10 10:31:45', '2018-05-10 10:31:45', 1, 0),
(95, 'student-subject_offer-edit', 'Edit', NULL, '2018-05-10 10:32:02', '2018-05-10 10:32:02', 1, 0),
(96, 'student-subject_offer-delete', 'Edit', NULL, '2018-05-10 10:32:35', '2018-05-10 10:32:35', 1, 0);
...
(2, 'Seven', 2, '2018-04-24 09:55:44', '2018-05-06 11:43:04', 1, 0, 1, NULL),
(3, 'Eight', 2, '2018-04-24 09:55:44', '2018-04-24 09:55:44', 1, 0, 1, NULL),
(4, 'Nine', 3, '2018-04-24 09:55:45', '2018-05-06 11:52:03', 1, 1, 1, NULL),
(5, 'Ten', 3, '2018-04-24 09:55:45', '2018-05-08 09:33:35', 1, 1, 1, NULL),
(6, 'test1', 1, '2018-05-06 11:52:31', '2018-05-06 11:52:34', 1, 0, 1, '2018-05-06 11:52:34');
...
(4, 'Class Six A', 1, 2, 1, 1, 1, 1, 2, 1, 22, '2018-04-30 10:28:02', '2018-05-10 09:59:57', 1, 1, 1, NULL),
(5, 'Class Six B', 1, 2, 1, 1, 2, 1, 1, 1, 22, '2018-04-30 10:28:41', '2018-05-10 09:59:54', 1, 0, 1, NULL);
...
(1, 'A', '2018-04-30 10:24:09', '2018-04-30 10:24:09', 1, 0, 1, NULL),
(2, 'B', '2018-04-30 10:24:17', '2018-05-06 11:54:55', 1, 1, 1, NULL),
(3, 'C', '2018-05-06 11:53:53', '2018-05-08 09:35:03', 1, 0, 1, NULL);
...
(1, '2018-2019', '2018-04-30 10:25:59', '2018-04-30 10:25:59', 1, 0, 1, NULL),
(2, '2017-2018', '2018-05-06 11:56:04', '2018-05-06 11:56:33', 1, 1, 2, NULL);
...
CREATE TABLE `students` (
  ...
  `applicant_id` int(10) UNSIGNED NOT NULL,
  `is_running` tinyint(4) NOT NULL DEFAULT '1' COMMENT '1=yes,2=no',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `created_by` int(11) NOT NULL,
  `updated_by` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `student_subject_offers`
--

CREATE TABLE `student_subject_offers` (
  `id` int(10) UNSIGNED NOT NULL,
  `student_promotion_id` int(10) UNSIGNED NOT NULL,
  `subject_offer_id` int(10) UNSIGNED NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL
...
(49, 'test1', 4, '331', 1, '2018-05-06 11:58:22', '2018-05-06 11:58:50', 1, 1, '2018-05-06 11:58:50');
...
INSERT INTO `subject_offers` (`id`, `program_offer_id`, `subject_id`, `teacher_id`, `subject_mark`, `created_at`, `updated_at`, `created_by`, `updated_by`, `status`, `deleted_at`) VALUES
(1, 4, 1, 1, '100.00', '2018-04-30 22:10:08', '2018-05-05 02:06:44', 1, 1, 1, NULL),
(2, 4, 2, 1, '50.00', '2018-04-30 22:10:08', '2018-05-05 02:07:05', 1, 1, 1, NULL),
(3, 4, 3, 1, '100.00', '2018-04-30 22:10:08', '2018-05-05 02:51:06', 1, 0, 1, NULL),
(4, 4, 4, 1, '100.00', '2018-04-30 22:10:08', '2018-04-30 22:34:01', 1, 0, 1, NULL),
(5, 4, 5, 1, '100.00', '2018-04-30 22:10:08', '2018-04-30 22:10:08', 1, 0, 1, NULL),
(6, 4, 6, 1, '100.00', '2018-04-30 22:10:08', '2018-04-30 22:34:14', 1, 0, 1, NULL),
(7, 4, 7, 1, '100.00', '2018-04-30 22:10:08', '2018-04-30 22:34:18', 1, 0, 1, NULL),
(8, 4, 8, 1, '100.00', '2018-04-30 22:10:08', '2018-04-30 22:10:08', 1, 0, 1, NULL),
(9, 4, 9, 1, '100.00', '2018-04-30 22:10:08', '2018-04-30 22:10:08', 1, 0, 1, NULL),
(10, 4, 10, 1, '100.00', '2018-04-30 22:10:08', '2018-04-30 22:10:08', 1, 0, 1, NULL),
(11, 4, 11, 1, '100.00', '2018-04-30 22:10:08', '2018-04-30 22:10:08', 1, 0, 1, NULL),
(12, 4, 12, 1, '100.00', '2018-04-30 22:10:08', '2018-04-30 22:10:08', 1, 0, 1, NULL),
(13, 4, 13, 1, '50.00', '2018-04-30 22:10:08', '2018-04-30 22:10:08', 1, 0, 1, NULL),
(14, 4, 14, 1, '100.00', '2018-04-30 22:10:08', '2018-04-30 22:10:08', 1, 0, 1, NULL),
(15, 4, 15, 1, '50.00', '2018-04-30 22:10:08', '2018-04-30 22:10:08', 1, 0, 1, NULL),
(16, 4, 16, 1, '50.00', '2018-04-30 22:10:08', '2018-04-30 22:10:08', 1, 0, 1, NULL),
(17, 4, 17, 1, '100.00', '2018-04-30 22:10:08', '2018-04-30 22:36:54', 1, 0, 1, '2018-04-30 22:36:54'),
(18, 4, 18, 1, '50.00', '2018-04-30 22:10:08', '2018-04-30 22:36:43', 1, 0, 1, '2018-04-30 22:36:43'),
(19, 4, 17, 1, '100.00', '2018-05-05 09:51:58', '2018-05-05 09:51:58', 1, 0, 1, NULL),
(20, 4, 18, 1, '50.00', '2018-05-05 09:51:58', '2018-05-05 09:51:58', 1, 0, 1, NULL),
(21, 5, 1, 1, '100.00', '2018-05-05 09:53:55', '2018-05-05 09:53:55', 1, 0, 1, NULL),
(22, 5, 2, 1, '50.00', '2018-05-05 09:53:55', '2018-05-05 09:53:55', 1, 0, 1, NULL);
...
INSERT INTO `teachers` (`id`, `teacher_code`, `full_name`, `employee_type`, `employment_status`, `designation_id`, `department_id`, `joining_date`, `dob`, `position`, `blood_group_id`, `religion_id`, `national_id_no`, `birth_reg_no`, `phone`, `email`, `sex`, `created_at`, `updated_at`, `created_by`, `updated_by`, `deleted_at`) VALUES
(1, '162344', 'Alam Khan', 0, 1, 1, 1, '2000-02-02', '2000-02-02', 3, NULL, 1, NULL, '433333', NULL, NULL, 1, '2018-04-30 10:23:44', '2018-04-30 10:23:44', 1, 0, NULL);
...
(1, 'Aminur Rahman', 'superadmin@gmail.com', '$2y$10$Qf3tFWXNt33i61LOYgaR1eWzcZh2PxMYb0.O3OVXgC9yev.kKHTAW', NULL, '2018-04-23 18:00:00', '2018-04-30 22:29:16', 1, 0, 2),
...
--
-- Indexes for table `distribute_marks`
--
ALTER TABLE `distribute_marks`
  ADD PRIMARY KEY (`id`),
  ADD KEY `distribute_marks_subject_offer_id_foreign` (`subject_offer_id`),
  ADD KEY `distribute_marks_mark_type_id_foreign` (`mark_type_id`);
...
--
-- Indexes for table `merge_subjects`
--
ALTER TABLE `merge_subjects`
  ADD PRIMARY KEY (`id`),
  ADD KEY `merge_subjects_subject_offer_id_foreign` (`subject_offer_id`);
...
ALTER TABLE `student_promotions`
  ...
  ADD KEY `student_promotions_program_offer_id_foreign` (`program_offer_id`);

--
-- Indexes for table `student_subject_offers`
--
ALTER TABLE `student_subject_offers`
  ADD PRIMARY KEY (`id`),
  ADD KEY `student_subject_offers_student_promotion_id_foreign` (`student_promotion_id`),
  ADD KEY `student_subject_offers_subject_offer_id_foreign` (`subject_offer_id`);
...
--
-- AUTO_INCREMENT for table `distribute_marks`
--
ALTER TABLE `distribute_marks`
...
--
-- AUTO_INCREMENT for table `merge_subjects`
--
ALTER TABLE `merge_subjects`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT for table `student_subject_offers`
--
ALTER TABLE `student_subject_offers`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `distribute_marks`
--
ALTER TABLE `distribute_marks`
  ADD CONSTRAINT `distribute_marks_mark_type_id_foreign` FOREIGN KEY (`mark_type_id`) REFERENCES `mark_types` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `distribute_marks_subject_offer_id_foreign` FOREIGN KEY (`subject_offer_id`) REFERENCES `subject_offers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `merge_subjects`
--
ALTER TABLE `merge_subjects`
  ADD CONSTRAINT `merge_subjects_subject_offer_id_foreign` FOREIGN KEY (`subject_offer_id`) REFERENCES `subject_offers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `students`
  ADD CONSTRAINT `students_applicant_id_foreign` FOREIGN KEY (`applicant_id`) REFERENCES `applicants` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `student_promotions`
--
ALTER TABLE `student_promotions`
  ADD CONSTRAINT `student_promotions_program_offer_id_foreign` FOREIGN KEY (`program_offer_id`) REFERENCES `program_offers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
-- Constraints for table `student_subject_offers`
--
ALTER TABLE `student_subject_offers`
  ADD CONSTRAINT `student_subject_offers_student_promotion_id_foreign` FOREIGN KEY (`student_promotion_id`) REFERENCES `student_promotions` (`id`),
  ADD CONSTRAINT `student_subject_offers_subject_offer_id_foreign` FOREIGN KEY (`subject_offer_id`) REFERENCES `subject_offers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
